...
static void dump_curve_test_data(const skcms_Curve* c) {
    ...
    printf("        { { %1.8ef, %1.8ef, %1.8ef, %1.8ef, %1.8ef, %1.8ef, %1.8ef },\n",
           (double)p->g, (double)p->a, (double)p->b, (double)p->c,
           (double)p->d, (double)p->e, (double)p->f);
    printf("          %s, %s, %u },\n",
...
static void dump_a2b_test_data(const char* filename, const skcms_A2B* a2b) {
    ...
    printf("    { { { %1.8ef, %1.8ef, %1.8ef, %1.8ef },\n",
