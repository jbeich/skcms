...
SKCMS_API bool skcms_TransferFuncton_makeHLGinvish(skcms_TransferFunction*
                                                   float R, float G,
                                                   float a, float b, float c);
...
SKCMS_API bool skcms_TransferFuncton_makeHLGish(skcms_TransferFunction*
                                                float R, float G,
                                                float a, float b, float c);

static bool skcms_TransferFuncton_makeHLG(skcms_TransferFuncton* tf) {
    return skcms_TransferFuncton_makeHLGish(tf,
            0.5f, 0.5f , 0.17883277f, 0.28466892f, 0.55991073f);
}
static bool skcms_TransferFunction_makeHLGinv(skcms_TransferFunction* tf) {
    return skcms_TransferFuncton_makeHLGishinv(tf,
            0.5f, 0.5f , 0.17883277f, 0.28466892f, 0.55991073f);
}
