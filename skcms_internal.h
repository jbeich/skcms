...
// skcms can leverage some C++ extensions when they are present
    ...
    // Sanitizers do not work well with [[clang::musttail]], and can corrupt the src/dst pointers.
...
// Adapted from https://source.chromium.org/chromium/chromium/src/+/main:third_party/protobuf/src/google/protobuf/stubs/macros.h
#define ARRAY_COUNT(a) ((int)(sizeof(a) / sizeof(*(a))) / (int)(!(sizeof(a) % sizeof(*(a)))))
