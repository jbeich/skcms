...
static void tf_eval_gradient_nonlinear(const skcms_TransferFunction* fn,
    ...
    if (base > 0.f) {
        *d_fn_d_A_at_x = fn->g * x * powf(base, fn->g - 1.f);
        *d_fn_d_B_at_x = fn->g * powf(base, fn->g - 1.f);
        *d_fn_d_E_at_x = 1.f;
...
static bool is_matrix_finite(const float* mtx) {
    float accumulator = 0;
    for (int i = 0; i < 16; ++i) {
        accumulator *= mtx[i];
    }
...
static bool invert_matrix(float* dst, const float* src) {
    double a00 = (double)src[0 * 4 + 0];
    double a01 = (double)src[1 * 4 + 0];
    double a02 = (double)src[2 * 4 + 0];
    double a03 = (double)src[3 * 4 + 0];
    double a10 = (double)src[0 * 4 + 1];
    double a11 = (double)src[1 * 4 + 1];
    double a12 = (double)src[2 * 4 + 1];
    double a13 = (double)src[3 * 4 + 1];
    double a20 = (double)src[0 * 4 + 2];
    double a21 = (double)src[1 * 4 + 2];
    double a22 = (double)src[2 * 4 + 2];
    double a23 = (double)src[3 * 4 + 2];
    double a30 = (double)src[0 * 4 + 3];
    double a31 = (double)src[1 * 4 + 3];
    double a32 = (double)src[2 * 4 + 3];
    double a33 = (double)src[3 * 4 + 3];
