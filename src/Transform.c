...
#else
    STORE_4(rgb+0, CAST(U16, Half_from_F(r)));
    STORE_4(rgb+1, CAST(U16, Half_from_F(g)));
    STORE_4(rgb+2, CAST(U16, Half_from_F(b)));
    STORE_4(rgb+3, CAST(U16, Half_from_F(a)));
#endif
    (void)ip;
    (void)src;
}
