...
#if N <= 4
    // Helper for gather_24_32(), loading the ix'th 24-bit value from p, and one extra byte.
...
// TODO: explain
SI U32 gather_24_32(const uint8_t* p, I32 ix) {
    ...
    U32 v = (U32)_mm512_i32gather_epi32((__m512i)(3*ix), p, 1);
#endif
    return v;
}
...
SI void clut_0_8(const skcms_A2B* a2b, I32 ix, I32 stride, F* r, F* g, F* b, F a) {
    U32 xrgb = gather_24_32(a2b->grid_8, ix);
