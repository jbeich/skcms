...
#if N == 8 && defined(__AVX__) && !defined(USING_AVX)
    #define USING_AVX
#endif
#if defined(USING_AVX) && defined(__F16C__) && !defined(USING_AVX_F16C)
    #define USING AVX_F16C
#endif
#if defined(USING_AVX) && defined(__AVX2__) && !defined(USING_AVX2)
    #define USING_AVX2
#endif
