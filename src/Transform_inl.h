...
#else
    // No compiler besides Clang supports a must-tail requirement; GCC is likely to do the right
    // thing, but there's no compile-time enforcement.
    #define MUSTTAIL
#endif
...
#define STAGE(name, arg) \
    DECLARE_STAGE(name, arg, MUSTTAIL return (*list.fn)(list, ctx, s, d, r, g, b, a, i))
