...
#define STAGE(name, arg)                                                                          \
    ...
    SI void Exec_##name(const void**& v, const char* s, char* d, F& r, F& g, F& b, F& a, int i) { \
        Exec_##name##_k(Arg{v}, s, d, r, g, b, a, i);                                             \
    }                                                                                             \
                                                                                                  \
