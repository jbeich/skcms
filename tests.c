...
static void test_PQ_HLG_SRGB_xform(void) {
    ...
    skcms_ICCProfile profiles[3] = {
        *skcms_sRGB_profile(),
        skcms_Rec2100PQ_profile(),
        skcms_Rec2100HLG_profile(),
    };
    const size_t num_test_colors = 4;
    const float test_colors[3][4 * 3] = {
        ...
        // Test colors in Rec2100PQ, manually computed.
        {
        ...
        // Test colors in Rec2100HLG, manually computed.
        {
