...
###########################################################
# Empty C++ toolchain configs necessary to appease Bazel. #
###########################################################

def _empty_k8_cc_toolchain_impl(ctx):
    return cc_common.create_cc_toolchain_config_info(
        ctx = ctx,
        toolchain_identifier = "k8-empty-toolchain",
        host_system_name = "local",
...
empty_k8_cc_toolchain_config = rule(
    implementation = _empty_k8_cc_toolchain_impl,
    provides = [CcToolchainConfigInfo],
    doc = "No-op K8 C++ toolchain to appease Bazel."
)

def _empty_x64_windows_cc_toolchain_impl(ctx):
    return cc_common.create_cc_toolchain_config_info(
        ctx = ctx,
        toolchain_identifier = "x64-windows-empty-toolchain",
        host_system_name = "local",
        target_system_name = "local",
...
empty_x64_windows_cc_toolchain_config = rule(
    implementation = _empty_x64_windows_cc_toolchain_impl,
    provides = [CcToolchainConfigInfo],
    doc = "No-op X64 Windows C++ toolchain to appease Bazel."
)
