...
def _impl(ctx):
    ...
    # under the directory in which it is invoked. This prevents us from referencing the tools under
    # external/android_ndk. The solution is to use "trampoline" scripts defined under this
    # directory, which pass through any command-line arguments to the underlying NDK binaries under
    ...
    tool_paths = [
        ...
        tool_path(
            name = "cpp",
            path = "trampolines/aarch64-linux-android-cpp.sh",
        ),
        tool_path(
            name = "dwp",
        ...
        tool_path(
            name = "gcov",
            path = "trampolines/aarch64-linux-android-gcov.sh",
        ),
        tool_path(
            name = "gcov_tool",
            path = "trampolines/aarch64-linux-android-gcov-tool.sh",
        ),
        tool_path(
            name = "ld",
        ...
        tool_path(
            name = "llvm_profdata",
            path = "trampolines/aarch64-linux-android-llvm-profdata.sh",
        ),
    ]
